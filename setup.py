...
setup(name='quantuminspire',
      ...
      data_files=[('share/doc/quantuminspire/examples',
                    ['docs/example_qiskit_entangle.py',
                     ...
                     'docs/grover-qi.png',
                     'docs/classifier_example/data_preprocessing_class.py',
                     'docs/classifier_example/classification_v2.ipynb',
                     'docs/classifier_example/classification_v3_4_data_points.ipynb',
                     'docs/classifier_example/classification_v4_4_features.ipynb']),
