...
class TestMeasurements(unittest.TestCase):
    ...
    def _circuit_to_qobj(circuit):
        ...
        backend = QuantumInspireBackend(Mock(), None)
    ...
    def test_validate_nr_classical_qubits_less_than_needed_for_storing_measured_qubits(self):
        ...
        self.assertRaisesRegex(
            QiskitBackendError,
            "Number of classical bits \(1\) is not sufficient for storing the " "outcomes of the experiment",
    ...
    def test_invalid_number_of_classical_bits(self):
        ...
        self.assertRaisesRegex(
            QiskitBackendError, "Invalid number of classical bits \(0\)!", Measurements.from_experiment, experiment
        )
    ...
    def test_get_qreg_for_conditional_creg(self):
        ...
        self.assertRaisesRegex(
            QiskitBackendError,
            "Classical bit 4 used in a conditional gate is not measured and the "
    ...
    def test_measurement_2_qubits_to_1_classical_bit(self):
        ...
        self.assertRaisesRegex(
            QiskitBackendError,
            "Measurement of different qubits to the same classical " "register 0 is not supported",
    ...
    def test_measurement_1_qubit_to_2_classical_bits(self):
        ...
        self.assertRaisesRegex(
            QiskitBackendError,
            "Measurement of qubit 1 to different classical registers " "is not supported",
            measurements.validate_unsupported_measurements,
        )
